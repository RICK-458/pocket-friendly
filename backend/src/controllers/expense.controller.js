...
export const deleteExpense = asyncHandler(async (req, res) => {
  const deleted = await expenseService.deleteExpense(req.user.id, req.params.id);
...
export const bulkDeleteExpenses = asyncHandler(async (req, res) => {
  const deletedCount = await expenseService.bulkDeleteExpenses(req.user.id, req.body.ids);
